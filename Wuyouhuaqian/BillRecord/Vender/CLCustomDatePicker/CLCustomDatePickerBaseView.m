...
@implementation CLCustomDatePickerBaseView
...
- (UIView *)alertView {
    if (!_alertView) {
        _alertView = [[UIView alloc] initWithFrame:CGRectMake(LEFTRIGHT_MARGIN, SCREEN_HEIGHT - kTopViewHeight - kPickerHeight - HJ_BottombarH, SCREEN_WIDTH - LEFTRIGHT_MARGIN * 2, kTopViewHeight + kPickerHeight + HJ_BottombarH)];
