...
@property (weak, nonatomic) IBOutlet YosKeepAccountsLeapButton *addBillBtn;
...
@property (weak, nonatomic) IBOutlet YosKeepAccountsCountingLabel *moneyLb;
...
- (void)setUpUI {
    ...
    [_addBillBtn setTintColor:YosKeepAccountsThemeColor];
    self.navigationController.delegate = self;
    self.tableHeaderScene.backgroundColor = YosKeepAccountsThemeColor;
    self.tableScene.tableType = YosKeepAccountsBillTableTypeMonth;
    WEAK_SELF
...
- (void)requestData {
    ...
    [[YosKeepAccountsSQLManager share] searchData:kSQLTableName
                                ...
                                result:^(NSMutableArray<YosKeepAccountsBillEntity *> *result, NSError *error) {
                                    ...
                                    double sum;
                                    NSArray *tempArray = [YosKeepAccountsBillEntity templateBillArrayWithBills:result sumMoney:&sum];
...
- (IBAction)addBillClick:(YosKeepAccountsLeapButton *)sender {
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if ([fromVC isKindOfClass:[YosKeepAccountsHomePresenter class]] &&
        [toVC isKindOfClass:[YosKeepAccountsEditBillPresenter class]] &&
