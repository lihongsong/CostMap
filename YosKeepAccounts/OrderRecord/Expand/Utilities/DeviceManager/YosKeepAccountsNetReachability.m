...
@interface YosKeepAccountsNetReachability ()
...
@end
@implementation YosKeepAccountsNetReachability
+ (instancetype)sharedManager {
    static YosKeepAccountsNetReachability *_sharedManager = nil;
...
+ (instancetype)managerForDomain:(NSString *)domain {
    ...
    YosKeepAccountsNetReachability *manager = [[self alloc] initWithReachability:reachability];
