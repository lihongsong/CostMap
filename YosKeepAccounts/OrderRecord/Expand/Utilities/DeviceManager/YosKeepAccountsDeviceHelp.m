...
+ (NSDictionary *)yka_collectDeviceInfo {
    ...
    NSString *devicename = [YosKeepAccountsDeviceHelp yka_currentDeviceName];
    NSString *operatorinfo = [YosKeepAccountsDeviceHelp yka_getcurrentDeviceTelephoneInformation];
    NSString *inputtype = [YosKeepAccountsDeviceHelp yka_readKeyBoardInputType];
    NSString *location = [YosKeepAccountsDeviceHelp yka_locationStr];
    NSString *battery = [NSString stringWithFormat:@"%f", [YosKeepAccountsDeviceHelp yka_batteryLevel]];
    NSString *cpuType = [UIDevice cpuType]; 
    NSDictionary *volume = [YosKeepAccountsDeviceHelp yka_getDeviceSound];
    NSString *yka_screenLight = [NSString stringWithFormat:@"%f", [YosKeepAccountsDeviceHelp yka_screenLight]];
    NSString *launchSystemTime = [NSString stringWithFormat:@"%f", [YosKeepAccountsDeviceHelp yka_getLaunchSystemTime]];
    NSLog(@"______%@",launchSystemTime);
    NSString *yka_appVersion       = [YosKeepAccountsDeviceHelp yka_appVersion];
    NSString *yka_appBundleId      = [YosKeepAccountsDeviceHelp yka_appBundleId];
    NSString *appBuildNum      = [YosKeepAccountsDeviceHelp yka_buildNumber];
