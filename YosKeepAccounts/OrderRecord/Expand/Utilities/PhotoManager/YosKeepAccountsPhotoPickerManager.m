#import "YosKeepAccountsPhotoPickerManager.h"
#import <AVFoundation/AVMediaFormat.h>
#import <AssetsLibrary/AssetsLibrary.h>
#import <AVFoundation/AVCaptureDevice.h>
@interface YosKeepAccountsPhotoPickerManager() <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (copy, nonatomic) YosKeepAccountsPhotoPickerBlock photoBlock;
@end
@implementation YosKeepAccountsPhotoPickerManager
static YosKeepAccountsPhotoPickerManager *manager;
+ (instancetype)share {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [YosKeepAccountsPhotoPickerManager new];
    });
    return manager;
}
- (void)photoPickerFromPresenter:(UIPresenter *)viewCotroller result:(YosKeepAccountsPhotoPickerBlock)result {
    if (_photoBlock) {
