...
@end
@implementation waveAnimationScene
...
-(void)initControls:(CGRect)frame{
   ...
   UIImageView *animationBGImage = [ZYZControl createImageSceneFrame:CGRectMake(0, frame.size.height - 22.5, frame.size.width, 22.5) imageName:@"home_bg_wave_mask"];
...
-(UIImageView *)animation1Image
{
    if (_animation1Image  == nil) {
        _animation1Image = [ZYZControl createImageSceneFrame:CGRectMake(0, 0, 750, 41) imageName:@"home_bg_wave_01"];
    }
...
-(UIImageView *)animation2Image
{
    if (_animation2Image  == nil) {
        _animation2Image = [ZYZControl createImageSceneFrame:CGRectMake(750, 0, 750, 41) imageName:@"home_bg_wave_01"];
    }
...
-(UIImageView *)animation4Image
{
    if (_animation4Image  == nil) {
        _animation4Image = [ZYZControl createImageSceneFrame:CGRectMake(750, 0, 750, 41) imageName:@"home_bg_wave_02"];
    }
...
-(UIImageView *)animation3Image
{
    if (_animation3Image  == nil) {
        _animation3Image = [ZYZControl createImageSceneFrame:CGRectMake(0, 0, 750, 41) imageName:@"home_bg_wave_02"];
    }
