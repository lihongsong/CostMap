...
- (void)initArrow:(CGRect)frame{
    self.bgScene = [ZYZControl createSceneWithFrame:CGRectMake(frame.size.width/2.0 - 7, 0, 14, frame.size.width)];
    UIImageView *arrowImage = [ZYZControl createImageSceneFrame:CGRectMake(0, 15, 14, 31) imageName:@"home_bg_dial_arrow"];
    UIImageView *lightImage = [ZYZControl createImageSceneFrame:CGRectMake(-7, -10, 29, 29) imageName:@"home_Light"];
