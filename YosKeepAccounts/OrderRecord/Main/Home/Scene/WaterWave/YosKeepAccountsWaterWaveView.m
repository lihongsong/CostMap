...
@interface YosKeepAccountsWaterWaveView ()
...
@implementation YosKeepAccountsWaterWaveView
...
- (void)startWaveAnimate {
    ...
    self.waterTimer = [CADisplayLink displayLinkWithTarget:[YosKeepAccountsWaterWeakProxy proxyWithTarget:self] selector:@selector(rippleAnimate)];
