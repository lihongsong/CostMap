...
@interface CostMapCustomDatePickerScene () <UIPickerViewDataSource, UIPickerViewDelegate> {
...
@property(nonatomic, assign) CostMapCustomDatePickerMode showType;
...
@property(nonatomic, copy) CostMapCustomDateResultBlock resultBlock;
@property(nonatomic, copy) CostMapCustomDateCancelBlock cancelBlock;
@end
@implementation CostMapCustomDatePickerScene
...
+ (CostMapCustomDatePickerScene *)showDatePickerWithTitle:(NSString *)title
    ...
    CostMapCustomDatePickerScene *datePickerScene = [[CostMapCustomDatePickerScene alloc] initWithTitle:title dateType:type defaultSelValue:defaultSelValue minDate:minDate maxDate:maxDate isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:cancelBlock];
...
- (void)setupSelectDateFormatter:(CostMapCustomDatePickerMode)type {
    switch (type) {
        case CostMapCustomDatePickerModeTime: {
            self.selectDateFormatter = @"HH:mm";
            self.style = BRDatePickerStyleSystem;
            _datePickerMode = UIDatePickerModeTime;
        }
            break;
        case CostMapCustomDatePickerModeDate: {
            self.selectDateFormatter = @"yyyy-MM-dd";
            self.style = BRDatePickerStyleSystem;
            _datePickerMode = UIDatePickerModeDate;
        }
            break;
        case CostMapCustomDatePickerModeDateAndTime: {
            self.selectDateFormatter = @"yyyy-MM-dd HH:mm";
            self.style = BRDatePickerStyleSystem;
            _datePickerMode = UIDatePickerModeDateAndTime;
        }
            break;
        case CostMapCustomDatePickerModeCountDownTimer: {
            self.selectDateFormatter = @"HH:mm";
            self.style = BRDatePickerStyleSystem;
            _datePickerMode = UIDatePickerModeCountDownTimer;
        }
            break;
        case CostMapCustomDatePickerModeYMDHM: {
            self.selectDateFormatter = @"yyyy-MM-dd HH:mm:ss";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeMDHM: {
            self.selectDateFormatter = @"MM-dd HH:mm";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeYMD: {
            self.selectDateFormatter = @"yyyy-MM-dd";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeYM: {
            self.selectDateFormatter = @"yyyy-MM";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeY: {
            self.selectDateFormatter = @"yyyy";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeMD: {
            self.selectDateFormatter = @"MM-dd";
            self.style = BRDatePickerStyleCustom;
        }
            break;
        case CostMapCustomDatePickerModeHM: {
            self.selectDateFormatter = @"HH:mm";
            self.style = BRDatePickerStyleCustom;
        }
            break;
...
- (void)scrollToSelectDate {
    ...
    if (self.showType == CostMapCustomDatePickerModeYMDHM) {
        indexArr = @[@(_yearIndex), @(_monthIndex), @(_dayIndex), @(_hourIndex), @(_minuteIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeMDHM) {
        indexArr = @[@(_monthIndex), @(_dayIndex), @(_hourIndex), @(_minuteIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeYMD) {
        indexArr = @[@(_yearIndex), @(_monthIndex), @(_dayIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeYM) {
        indexArr = @[@(_yearIndex), @(_monthIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeY) {
        indexArr = @[@(_yearIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeMD) {
        indexArr = @[@(_monthIndex), @(_dayIndex)];
    } else if (self.showType == CostMapCustomDatePickerModeHM) {
