...
@interface CostMapDaySelectedScene ()
@property (weak, nonatomic) IBOutlet UILabel *dateLabel;
@property (strong, nonatomic, readwrite) NSDate *currentDate;
@end
@implementation CostMapDaySelectedScene
+ (instancetype)instance {
    return (CostMapDaySelectedScene *)[[[NSBundle mainBundle] loadNibNamed:@"CostMapDaySelectedScene"
                                                                 owner:nil
