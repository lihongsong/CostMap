...
- (void)initUi{
    ...
    UIImageView *fingerImage = [ZYZControl createImageViewFrame:CGRectMake(self.view.hj_width/2.0 - 31.5, self.view.hj_height/2.0 - 31.5, 63, 63) imageName:@"home_ic_Touch ID"];
