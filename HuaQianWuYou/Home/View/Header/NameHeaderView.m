...
-(void)initControls:(CGRect)frame{
    UIImageView *faceImage = [ZYZControl createImageViewFrame:CGRectMake(17, frame.size.height/2.0 - 10, 33, 23) imageName:@"home_ic_smile"];
    ...
    self.exampleImage = [ZYZControl createImageViewFrame:CGRectMake(CGRectGetMaxX(self.nameLabel.frame) + 5,self.nameLabel.center.y - 8.5, 58, 17) imageName:@"home_ic_label"];
