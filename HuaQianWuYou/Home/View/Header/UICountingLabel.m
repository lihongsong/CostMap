...
- (void)setTextValue:(CGFloat)value
{
    ...
    else
    {
        ...
        {
            self.text = [NSString stringWithFormat:@"%@%%",[NSString stringWithFormat:self.format,(int)value]];
        }
        else
        {
            self.text = [NSString stringWithFormat:@"%@%%",[NSString stringWithFormat:self.format,value]];
        }
    }
}
