...
- (void)setDataModel:(DiscoverDetailModel *)dataModel {
    ...
    CGSize textSize = [self.articalView sizeThatFits:CGSizeMake(SWidth, CGFLOAT_MAX)];
    [self.articalView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(textSize.height + 40);
    }];
