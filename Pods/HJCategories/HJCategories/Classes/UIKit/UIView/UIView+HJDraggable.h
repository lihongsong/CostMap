...
/** The pan gestures that handles the view dragging
 hj_panGesture The tint color of the blurred view. Set to nil to reset.
 */
@property (nonatomic) UIPanGestureRecognizer *hj_panGesture;
 ...
 */
@property (nonatomic) CGRect hj_cagingArea;
 ...
 */
@property (nonatomic) CGRect hj_handle;

/**
 Restricts the movement along the X axis
 */
@property (nonatomic) BOOL hj_shouldMoveAlongX;

/**
 Restricts the movement along the Y axis
 */
@property (nonatomic) BOOL hj_shouldMoveAlongY;

/**
 Notifies when dragging started
 */
@property (nonatomic, copy) void (^hj_draggingStartedBlock)(void);

/**
 Notifies when dragging ended
 */
@property (nonatomic, copy) void (^hj_draggingEndedBlock)(void);
