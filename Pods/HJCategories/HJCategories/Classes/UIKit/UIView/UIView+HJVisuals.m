...
// Degree -> Rad
#define hj_degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (HJVisuals)
...
-(void)hj_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)hj_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)hj_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
    [UIView beginAnimations: nil context: NULL];
    [UIView setAnimationDuration: duration];
         ...
         timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: hj_degToRad(angle)];
