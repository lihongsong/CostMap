...
//    NSMutableDictionary *dict = nil;
    ...
    if (queryErr == errSecSuccess) {
        ...
        if (udidValue) {
            NSData *udidData = (__bridge NSData *)udidValue;
            udid = [NSString stringWithUTF8String:udidData.bytes];
        }
    }
    return udid;
}
...
+ (BOOL)settUDIDToKeyChain:(NSString*)udid
{
    ...
    [dictForAdd setValue:[NSString stringWithUTF8String:kKeychainUDIDItemIdentifier]
                  forKey:(__bridge NSString *)kSecAttrDescription];
...
//    NSDictionary *queryResult = nil;
    ...
    if (queryResult) {
        ...
        [dictForUpdate setValue:[NSString stringWithUTF8String:kKeychainUDIDItemIdentifier]
                         forKey:(__bridge NSString *)kSecAttrDescription];
        ...
        NSDictionary *queryResultDic = (__bridge NSDictionary *)queryResult;
        NSMutableDictionary *updateItem = [NSMutableDictionary dictionaryWithDictionary:queryResultDic];
