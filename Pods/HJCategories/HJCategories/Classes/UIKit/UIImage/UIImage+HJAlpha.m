...
@implementation UIImage (HJAlpha)
 ...
 *  @return 增加透明边框后的图片
 */
- (UIImage *)hj_transparentBorderImage:(NSUInteger)borderSize {
    // If the image does not have an alpha layer, add one
    UIImage *image = [self hj_imageWithAlpha];
    ...
    CGImageRef maskImageRef = [self hj_newBorderMask:borderSize size:newRect.size];
...
- (CGImageRef)hj_newBorderMask:(NSUInteger)borderSize size:(CGSize)size {
